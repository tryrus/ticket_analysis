...
def query(date, from_station, to_station):
    ...
    headers = {
        'Cookie': 'JSESSIONID=FA4CF6AFF8A510F9960076B506520DEE; RAIL_EXPIRATION=1578961197657; RAIL_DEVICEID=En3NnHUhq6zD_sBxj7dHgLHBTQgA5WbqOog2ryj3PmO4ry9topHM_v-Qimv0KlD59uk2p9QMkVhSOVh9XkNm0d8G84MXH_be4HXcn7f4muyt8Ojpnn5J6B8MNbHRk6fanvDJ5ZlACBQgXPif7HwCn-yVzOUa9kH9; _jc_save_fromStation=%u5317%u4EAC%2CBJP; _jc_save_toStation=%u4E4C%u9C81%u6728%u9F50%u5357%2CWMR; _jc_save_fromDate=2020-01-13; _jc_save_toDate=2020-01-12; _jc_save_wfdc_flag=dc; BIGipServerotn=535298314.24610.0000; BIGipServerpassport=770179338.50215.0000; route=9036359bb8a8a461c164a04f8f50b252'}
...
def query_time(station, station_code):
    url = 'https://www.12306.cn/index/otn/index12306/queryScSname'  # 请求地址
    form_data = {"station_telecode": station_code}  # 表单参数，station参数为需要搜索车站的英文缩写
    ...
    data = json_data.get('data')  # 获取json中可用数据，也就是查询车站所对应的站名,只用到了站名
